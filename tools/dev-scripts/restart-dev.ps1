# SQLBot 本地开发环境重启脚本 (PowerShell)
# 使用方法: .\restart-dev.ps1
...
Write-Separator
Write-ColorMessage "  SQLBot 本地开发环境重启" $colors.Header
Write-Separator
Write-Host ""
...
# 第一步：停止现有服务
# ============================================
Write-ColorMessage "[INFO] 正在停止现有服务..." $colors.Info
Write-Host ""
...
# 等待进程完全停止
Write-ColorMessage "[INFO] 等待服务完全停止..." $colors.Info
Start-Sleep -Seconds 3

Write-Host ""
Write-Separator
Write-ColorMessage "  所有服务已停止，准备重新启动" $colors.Success
Write-Separator
Write-Host ""
...
Write-Host ""
Write-Separator
Write-ColorMessage "  SQLBot 重启完成!" $colors.Success
Write-Separator
Write-Host ""
